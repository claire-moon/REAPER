...
#if PSYDOOM_MODS
    InterpFixedT    floorTexOffsetY;    // PsyDoom: floor texture y offset (can be used to scroll flats)
    InterpFixedT    ceilTexOffsetX;     // PsyDoom: ceiling texture x offset (can be used to scroll flats)
    InterpFixedT    ceilTexOffsetY;     // PsyDoom: ceiling texture y offset (can be used to scroll flats)
#endif
